            ...
            <section className="max-w-screen-xl mx-auto px-4 relative pb-1 sm:pb-16">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <img
                                className="max-w-[250px] mr-[180px] w-full relative z-10 drop-shadow-[0_0px_60px_rgba(59,130,246,0.6)]"
                                src={docwise}
                                alt=""
                            />
                            <span
                                className="flex group-hover:-top-14 ease-jump duration-200 text-black bg-[#ffe578] sm:absolute left-1/3 sm:-translate-x-1/2 top-5 px-2 py-1 text-sm sm:text-base mt-2 rounded w-max items-center gap-1 after:hidden sm:after:block after:w-4 after:h-4 after:bg-inherit after:absolute after:left-1/3 after:-translate-x-1/2 after:rotate-45 after:-bottom-2"
                            >DocWise
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
