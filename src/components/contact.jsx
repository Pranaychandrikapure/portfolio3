...
const Contact = () => {
    ...
    <>
      ...
      <div className="relative z-20 flex flex-col md:flex-row items-center mt-10">
        <div className="w-full">
          <img src={svg1} alt="phone" />
        </div>
        <form action="https://formspree.io/f/xjkblopp" method="POST" className="w-full relative z-30" name="contactUS">
          <label htmlFor="name" className="text-white relative z-40">Name</label>
          ...
          <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white relative z-40">Your Email</label>
          <div className="relative mb-4">
            <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
          ...
          <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white relative z-40">Message</label>
          <div className="relative mb-4">
